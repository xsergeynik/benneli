...
$(document).ready(function () {
        ...
        // Telegram   
        $(".question__form,#form-popup").submit(function () {
    ...
    $('.services__hidden').slice(0, 3).show();
        $('#services__btn-more').on('click', function (e) {
            e.preventDefault();
            $('.services__hidden:hidden').slice(0, 6).slideDown();
        });
    
    $(document).ready(function () {
        $("#gallery__wrap").lightGallery({
            thumbnail: true
        });
    });
...
//Burger menu
        ...
        $('.menu__item a').click(function (event) {
            $('.icon-menu,.menu').removeClass('_active');

...
let slider_sets_1 = new Swiper('.slider-sets__slider--1', {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
...
let slider_sets_2 = new Swiper('.slider-sets__slider--2', {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	speed: 800,
	navigation: {
		nextEl: '.slider-sets__wrapper--2 .slider-arrow.slider-arrow--next',
		prevEl: '.slider-sets__wrapper--2 .slider-arrow.slider-arrow--prev',
	},
	breakpoints: {
		320: {
			slidesPerView: 1.15,
...
let slider_sets_3 = new Swiper('.slider-sets__slider--3', {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	speed: 800,
	navigation: {
		nextEl: '.slider-sets__wrapper--3 .slider-arrow.slider-arrow--next',
		prevEl: '.slider-sets__wrapper--3 .slider-arrow.slider-arrow--prev',
	},
	breakpoints: {
		320: {
			slidesPerView: 1.15,
...
let slider_sets_4 = new Swiper('.slider-sets__slider--4', {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	speed: 800,
	navigation: {
		nextEl: '.slider-sets__wrapper--4 .slider-arrow.slider-arrow--next',
		prevEl: '.slider-sets__wrapper--4 .slider-arrow.slider-arrow--prev',
	},
	breakpoints: {
		320: {
			slidesPerView: 1.15,
...
let slider_parthers = new Swiper('.parthers__slider', {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	function animNumb() {
		...
		$(window).on("scroll load resize", function () {
			...
			if (w_top + 900 >= e_top || w_height + w_top == d_height || e_height + e_top < w_height) {
				$('.box-gifts__numb').css('opacity', '1');
				$('.box-gifts__numb').spincrement({
					from: 5,
					thousandSeparator: "",
					duration: 3000,
				});

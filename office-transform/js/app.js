...
$(document).ready(function () {
	...
	// 		$('.siderbar__inner').addClass("_active");
	// 	}
	// 	else {
	// 		$('.siderbar__inner').removeClass("_active");
	// 	}
	// });
	...
	$(".donate-cards__img_1").on("click", function () {
		copyToClipboard(".donate-cards__score_1");
		$(".donate-cards__item_1").toggleClass("_active");
	});

	// copy coupone code to clipboard
	$(".donate-cards__img_2").on("click", function () {
		copyToClipboard(".donate-cards__score_2");
		$(".donate-cards__item_2").toggleClass("_active");
	});

	// $('.page__wrap').scroll(function () {
	...
	/* prepend menu icon */
	// $('.tags-blog').prepend('<div id="menu-icon">Menu</div>');

	/* toggle nav */
	// $(".tags-blog .tags-icon").on("click", function () {
	// 	$(".tags-blog").slideToggle();
	// 	$(this).toggleClass("_active");
	// });


	var $sections = $('.about__section');
...
$("widget.widget_anchors").on("click", "a", function (event) {
